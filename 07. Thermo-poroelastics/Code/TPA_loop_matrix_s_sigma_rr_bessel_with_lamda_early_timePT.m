...
%k_PT_matrix =[1e-9, 1e-10, 1e-14];
k_PT_matrix =[1e-18, 1e-10, 1e-9];
%k_PT_matrix =[1e-22, 1e-18, 1e-9];
...
leg1 = legend('k_{pt}/k =10^{1}','k_{pt}/k=10^{5}','k_{pt}/k=10^{9}');
