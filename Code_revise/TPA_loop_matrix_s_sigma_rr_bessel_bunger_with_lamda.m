...
%   RR_p = abs(RR_p);
%end
%plot(Rx,RR_T, 'Color', blueGRADIENTflexible(mmm,nn),'LineWidth',2);
plot(Rx,RR_p, 'Color', blueGRADIENTflexible(mmm,nn),'LineWidth',2);
%plot(Rx,-RR_p, 'Color', blueGRADIENTflexible(mmm,nn),'LineWidth',1.5);
